...
<div class="container-fluid m-0 px-0">
   ...
   <nav class="navbar navbar-expand-md mx-0 px-5 navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand py-0" href="index.php"> Admin> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav d-flex justify-content-around w-100">
                    <div class="nav-item px-5">
                        <a class="nav-link <?php echo ($active == 'index.php')? 'active' : '' ?>" aria-current="page"  href="index.php">Vista</a>
                    </div> 
                    <div class="nav-item px-5">
                        <a class="nav-link <?php echo ($active == 'gestionar.php')? 'active' : '' ?>" aria-current="page"  href="gestionar.php">Paginas</a>
                    </div> 
                    <div class="nav-item px-5">
